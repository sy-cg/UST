...
class USTv2_GRU4Rec(GRU4Rec):
    """USTv2-enhanced GRU4Rec for unified multimodal sequence modeling."""
    ...
    def __init__(self, config, dataset):
        ...
        self.fusion = USTv2Fusion(hidden_size=self.embedding_size, dropout=fusion_dropout)
    ...
    def forward(self, item_seq, item_seq_len, advance_token_step=False):
        ...
        item_seq_emb_dropout = self.emb_dropout(z_i)
